<?php
$connection = new PDO('mysql:host=localhost:3307;dbname=pcstore',"root","");
...
if ($_POST ['register']) {
    ...
    $check = $connection->query("SELECT * FROM User WHERE Username = '" . $username . "'")->fetch();
...
<div class="container-fluid mx-auto text-center" style="width:100%; max-width: 1000px;">
    <!-- <a href="index.php"> -->
    <img src="Pictures\Main Page\logo6v2.png" class="logo" style="width:100%; max-width:700px">
</div>
